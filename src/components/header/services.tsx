  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        <Title level={2} style={{ color: '#0047ab', marginBottom: 8 }}>Our Services</Title>
      ...
      >
        ...
        <Col xs={24} md={12} style={{ textAlign: 'center' }}>
          <Image
            src="/service-card-stack.png"
            alt="Email Upload Feature"
            width={600}
            height={400}
            style={{ maxWidth: '100%', height: 'auto', borderRadius: 16, boxShadow: '0 10px 40px rgba(0,0,0,0.1)' }}
          />
        </Col>
